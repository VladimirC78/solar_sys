...
def RK4(space_objects, dt):
    ...
    for i in range(len(space_objects)):
        ...
        space_objects[i].Vx += dt / 6 * (
                space_objects[i].Fx / space_objects[i].m + 2 * k1[i].Fx / k1[i].m + 2 * k2[i].Fx / k2[i].m + k3[
            i].Fx / k3[i].m)
        space_objects[i].Vy += dt / 6 * (
                space_objects[i].Fy / space_objects[i].m + 2 * k1[i].Fy / k1[i].m + 2 * k2[i].Fy / k2[i].m + k3[
            i].Fy / k3[i].m)
